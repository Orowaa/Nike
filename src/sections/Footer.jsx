  ...
  return (
    <footer className='max-container'>
            ...
            <div key={section.id}>
              ...
              <ul>
                {section.links.map((link) => (
                  <li
                    className='mt-3 font-montserrat text-base leading-normal text-white hover:text-grey'
                    key={link.id}
                  >
      ...
      <div className='flex justify-between text-white mt-24 max-sm:flex-col max-sm:items-center'>
        ...
        <p className='font-montserrat cursor-pointer'>Nykee Clone by Serge Boucka</p>
      </div>
    </footer>
  );
};
